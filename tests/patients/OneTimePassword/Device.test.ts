...
export default class DeviceTestGroup {
  ...
  @Test("should respond with HTTP status 500 if an invalid initialCode is submitted")
  ...
  @Test("should respond with HTTP status 500 if an invalid secret is submitted")
  ...
  @Test("should respond with HTTP status 400 if no deviceName is submitted")
  ...
  @Test("should respond with HTTP status 400 if no initialCode is submitted.")
  ...
  @Test("should respond with HTTP status 400 if no secret is submitted.")
